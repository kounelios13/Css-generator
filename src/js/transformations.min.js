...
(function($, window, document) {
	...
	var updateMechanism = {
		...
		updateTextShadowValues: function() {
			text_shadow_x = this.int("#text_shadow_x");
			text_shadow_y = this.int("#text_shadow_y");
		...
		updateAllValues: function() {
			...
			this.updateBoxShadowValues();
			this.updateTextShadowValues();
			this.updateBorderRadiusValues();
		}
	};
	function update() {
		updateMechanism.updateAllValues();
	} //update
