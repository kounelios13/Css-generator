"use strict";
var x='',y='',z='',final_transformation='',scalex='',scaley='',translatex='',translatey='',translatez='',skewY='',skewX='',is2dmatrix=false;//transformations
...
$(document).ready(function(){
	...
	$(".ultra_app").on("input change touchmove",function(){
		update();
		log("Traslate z value:"+translatez);
