...
var showGeneratorList = function() {
    ...
    bootbox.alert({
        ...
        callback: function() {
            ...
            visibleGenerators = $(".generatorItemSelected");
            if (list)
    ...
    log(visibleGeneratorsIndex)
    if (len(visibleGeneratorsIndex) == 4 || len($(".generatorContainer:visible")) == 4) {
