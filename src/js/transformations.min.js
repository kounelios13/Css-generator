...
(function($, window, document, exports) {
	...
	var selectBg = () => {
		var cssObject = {
			"background": "url(../css/images/(1).jpg) no-repeat center center fixed",
		...
		bootbox.alert({
			...
			callback: () => {
				...
				cssObject.background = "url(../css/images/("+imageNum+").jpg) no-repeat center center fixed";
				domCache.get("body").css(cssObject,"!important");
				log(str);
			}
		});
